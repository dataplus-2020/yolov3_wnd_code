...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/jovyan/work/code/yxu-yolov3-xview/weights/1_cls/syn_mixed_seed17/hgiou1_1gpu_seed17_2020-06-17_05.54/last_seed17.pt', help='path to weights file')
    ...
    parser.add_argument('--data', type=str, default='/home/jovyan/work/data/syn_background_gt_bbox/syn_mixed_seed17.data', help='data xview folder')
